...
defineMessages({
  hohhButton: {
    id: 'components.SampleCensus.nonHohh_button',
...
const sampleCensusButtons = [
  ...
  {
    button: 'components.SampleCensus.nonHohh_button',
    description: 'components.SampleCensus.nonHohh_description',
        ...
        <div className="c_sample-census__content">
            ...
            { sampleCensusButtons.map((item, index) => (
              <button
                ...
                className={classnames(
                  hohhButtonClassName,
                  {
                    [`${hohhButtonClassName}--active`]: (index === this.state.questionsType)
                  }
                )}
                ...
                <p>
                  <FormattedMessage id={item.button} />
                </p>
              </button>
            ))}
          </div>
          <p className="c_sample-census__content__hohh-description">
            <FormattedMessage id={ sampleCensusButtons[this.state.questionsType].description } />
          </p>
          <ul className="c_sample-census__content__button-row">
            { sampleCensusButtons[this.state.questionsType].questions.map((item, index) => (
              <li
                key={index}
          ...
          <ul className={censusQuestionsClassName}>
            { sampleCensusButtons[this.state.questionsType].questions.map((item, index) => (
              <CensusQuestionCard
                className={
                  this.state.questionPosition === index
                ...
                item={item}
                index={index}
                currentPosition={this.state.questionPosition}>
              </CensusQuestionCard>
            ))}
          </ul>
        </div>
